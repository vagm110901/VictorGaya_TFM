...
png(paste0(saveDir, "/results/patient19_merge_alignTR_S.png"))
...
ggsave(paste0(saveDir, "/results/patient19_merge_alignTR_S_region.png"), plot = palign)
...
ggsave(paste0(saveDir, "/results/patient19_merge_alignTR_S_genesmt.png"), plot = pmt)

###############################################################################

saveRDS(pacientes.seurat, paste0(saveDir, "/results/patient19_merge_alignTR_S.rds"))
#pacientes.seurat <- readRDS(paste0(saveDir, "/results/patient19_merge_alignTR_S.rds"))
#pacientes.semla <- pacientes.seurat
saveRDS(Evaluation, paste0(saveDir, "/results/patient19_EVALUATION_merge_alignTR_S.rds"))
...
for (i in 2:length(pacientes.seurat.split.orig)) {
  ...
  savename <- paste0("/results/patient19_merge_alignTR_S_list_im", i, ".rds")
  saveRDS(listaObjDeconv, paste0(saveDir, savename))
}

############################################################################### Statistical part
Evaluation <- readRDS(paste0(saveDir, "/results/patient19_EVALUATION_merge_alignTR_S.rds"))
...
ggsave(paste0(saveDir, "/results/patient19_merge_alignTR_S_evalSSIM.png"), plot = pSSIM)
ggsave(paste0(saveDir, "/results/patient19_merge_alignTR_S_evalEucl.png"), plot = pEucl)

...
png(paste0(saveDir, "/results/patient19_merge.png"))
ImagePlot(pacientes.semla)
title("Original H&E image", line = -12.8)
dev.off()
png(paste0(saveDir, "/results/patient19_merge_alignTR.png"))
...
ggsave(paste0(saveDir, "/results/patient19_merge_alignTR_region.png"), plot = palign)
...
ggsave(paste0(saveDir, "/results/patient19_merge_alignTR_genesmt.png"), plot = pmt)

###############################################################################

saveRDS(pacientes.seurat, paste0(saveDir, "/results/patient19_merge_alignTR.rds"))
#pacientes.seurat <- readRDS(paste0(saveDir, "/results/patient19_merge_alignTR.rds"))
#pacientes.semla <- pacientes.seurat
saveRDS(Evaluation, paste0(saveDir, "/results/patient19_EVALUATION_merge_alignTR.rds"))
...
for (i in 2:length(pacientes.seurat.split.orig)) {
  ...
  savename <- paste0("/results/patient19_merge_alignTR_list_im", i, ".rds")
  saveRDS(listaObjDeconv, paste0(saveDir, savename))
}

############################################################################### Statistical part
Evaluation <- readRDS(paste0(saveDir, "/results/patient19_EVALUATION_merge_alignTR.rds"))
...
ggsave(paste0(saveDir, "/results/patient19_merge_alignTR_evalMSE.png"), plot = pMSE)
ggsave(paste0(saveDir, "/results/patient19_merge_alignTR_evalMSEgray.png"), plot = pMSEgray)
ggsave(paste0(saveDir, "/results/patient19_merge_alignTR_evalSSIM.png"), plot = pSSIM)
ggsave(paste0(saveDir, "/results/patient19_merge_alignTR_evalEucl.png"), plot = pEucl)
...
ggsave(paste0(saveDir, "/results/patient19_merge_alignTR_eval1.png"), plot = peval1)
...
ggsave(paste0(saveDir, "/results/patient19_merge_alignTR_eval2.png"), plot = peval2)
...
ggsave(paste0(saveDir, "/results/patient19_merge_alignTR_eval3.png"), plot = peval3)
...
ggsave(paste0(saveDir, "/results/patient19_merge_alignTR_eval4.png"), plot = peval4)

...
dev.off()
png(paste0(saveDir, "/results/patientMIX_merge_procrustes.png"))
...
ggsave(paste0(saveDir, "/results/patientMIX_merge_procrustes_region.png"), plot = palign)
...
ggsave(paste0(saveDir, "/results/patientMIX_merge_procrustes_genesmt.png"), plot = pmt)

###############################################################################

saveRDS(pacientes.seurat, paste0(saveDir, "/results/patientMIX_merge_procrustes.rds"))
#pacientes.seurat <- readRDS(paste0(saveDir, "/results/patientMIX_merge_procrustes.rds"))
#pacientes.semla <- pacientes.seurat
saveRDS(Evaluation, paste0(saveDir, "/results/patientMIX_EVALUATION_merge_procrustes.rds"))
...
for (i in 2:length(pacientes.seurat.split.orig)) {
  ...
  savename <- paste0("/results/patientMIX_merge_procrustes_list_im", i, ".rds")
  saveRDS(listaObjDeconv, paste0(saveDir, savename))
}

############################################################################### Statistical part
Evaluation <- readRDS(paste0(saveDir, "/results/patientMIX_EVALUATION_merge_procrustes.rds"))
...
ggsave(paste0(saveDir, "/results/patientMIX_merge_procrustes_evalMSE.png"), plot = pMSE)
ggsave(paste0(saveDir, "/results/patientMIX_merge_procrustes_evalMSEgray.png"), plot = pMSEgray)
ggsave(paste0(saveDir, "/results/patientMIX_merge_procrustes_evalSSIM.png"), plot = pSSIM)
ggsave(paste0(saveDir, "/results/patientMIX_merge_procrustes_evalEucl.png"), plot = pEucl)
...
ggsave(paste0(saveDir, "/results/patientMIX_merge_procrustes_eval1.png"), plot = peval1)
...
ggsave(paste0(saveDir, "/results/patientMIX_merge_procrustes_eval2.png"), plot = peval2)
...
ggsave(paste0(saveDir, "/results/patientMIX_merge_procrustes_eval3.png"), plot = peval3)
...
ggsave(paste0(saveDir, "/results/patientMIX_merge_procrustes_eval4.png"), plot = peval4)

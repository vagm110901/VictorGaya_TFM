...
png(paste0(saveDir, "/results/patient19_merge_procrustes_S.png"))
...
ggsave(paste0(saveDir, "/results/patient19_merge_procrustes_S_region.png"), plot = palign)
...
ggsave(paste0(saveDir, "/results/patient19_merge_procrustes_S_genesmt.png"), plot = pmt)

###############################################################################


saveRDS(pacientes.seurat, paste0(saveDir, "/results/patient19_merge_procrustes_S.rds"))
#pacientes.seurat <- readRDS(paste0(saveDir, "/results/patient19_merge_procrustes_S.rds"))
#pacientes.semla <- pacientes.seurat
saveRDS(Evaluation, paste0(saveDir, "/results/patient19_EVALUATION_merge_procrustes_S.rds"))
...
for (i in 2:length(pacientes.seurat.split.orig)) {
  ...
  savename <- paste0("/results/patient19_merge_procrustes_S_list_im", i, ".rds")
  saveRDS(listaObjDeconv, paste0(saveDir, savename))
}

############################################################################### Statistical part
Evaluation <- readRDS(paste0(saveDir, "/results/patient19_EVALUATION_merge_procrustes_S.rds"))
...
ggsave(paste0(saveDir, "/results/patient19_merge_procrustes_S_evalMSE.png"), plot = pMSE)
ggsave(paste0(saveDir, "/results/patient19_merge_procrustes_S_evalMSEgray.png"), plot = pMSEgray)
ggsave(paste0(saveDir, "/results/patient19_merge_procrustes_S_evalSSIM.png"), plot = pSSIM)
ggsave(paste0(saveDir, "/results/patient19_merge_procrustes_S_evalEucl.png"), plot = pEucl)
...
ggsave(paste0(saveDir, "/results/patient19_merge_procrustes_S_eval1.png"), plot = peval1)
...
ggsave(paste0(saveDir, "/results/patient19_merge_procrustes_S_eval2.png"), plot = peval2)
...
ggsave(paste0(saveDir, "/results/patient19_merge_procrustes_S_eval3.png"), plot = peval3)
...
ggsave(paste0(saveDir, "/results/patient19_merge_procrustes_S_eval4.png"), plot = peval4)

...
png(paste0(saveDir, "/results/patientMIX_merge_imageJ.png"))
...
ggsave(paste0(saveDir, "/results/patientMIX_merge_imageJ_region.png"), plot = palign)
...
ggsave(paste0(saveDir, "/results/patientMIX_merge_imageJ_genesmt.png"), plot = pmt)

###############################################################################

saveRDS(pacientes.seurat, paste0(saveDir, "/results/patientMIX_merge_imageJ.rds"))
#pacientes.seurat <- readRDS(paste0(saveDir, "/results/patientMIX_merge_imageJ.rds"))
#pacientes.semla <- pacientes.seurat
saveRDS(Evaluation, paste0(saveDir, "/results/patientMIX_EVALUATION_merge_imageJ.rds"))
...
for (i in 2:length(pacientes.seurat.split.orig)) {
  ...
  savename <- paste0("/results/patientMIX_merge_imageJ_list_im", i, ".rds")
  saveRDS(listaObjDeconv, paste0(saveDir, savename))
}

############################################################################### Statistical part
Evaluation <- readRDS(paste0(saveDir, "/results/patientMIX_EVALUATION_merge_imageJ.rds"))
...
ggsave(paste0(saveDir, "/results/patientMIX_merge_imageJ_evalMSE.png"), plot = pMSE)
ggsave(paste0(saveDir, "/results/patientMIX_merge_imageJ_evalMSEgray.png"), plot = pMSEgray)
ggsave(paste0(saveDir, "/results/patientMIX_merge_imageJ_evalSSIM.png"), plot = pSSIM)
ggsave(paste0(saveDir, "/results/patientMIX_merge_imageJ_evalEucl.png"), plot = pEucl)
...
ggsave(paste0(saveDir, "/results/patientMIX_merge_imageJ_eval1.png"), plot = peval1)
...
ggsave(paste0(saveDir, "/results/patientMIX_merge_imageJ_eval2.png"), plot = peval2)
...
ggsave(paste0(saveDir, "/results/patientMIX_merge_imageJ_eval3.png"), plot = peval3)
...
ggsave(paste0(saveDir, "/results/patientMIX_merge_imageJ_eval4.png"), plot = peval4)

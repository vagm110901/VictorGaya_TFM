...
target_dir <- "/Users/vagm_110901/Documents/Universitat/ConesaLab/Lab/05.ImageJ/ImagenesAlinearFiji/pacienteMIXaligned_scale"
#ref_name <- "original"
...
png(paste0(saveDir, "/results/patientMIX_merge_imageJ_S.png"))
...
ggsave(paste0(saveDir, "/results/patientMIX_merge_imageJ_S_region.png"), plot = palign)
...
ggsave(paste0(saveDir, "/results/patientMIX_merge_imageJ_S_genesmt.png"), plot = pmt)

###############################################################################

saveRDS(pacientes.seurat, paste0(saveDir, "/results/patientMIX_merge_imageJ_S.rds"))
#pacientes.seurat <- readRDS(paste0(saveDir, "/results/patientMIX_merge_imageJ_S.rds"))
#pacientes.semla <- pacientes.seurat
saveRDS(Evaluation, paste0(saveDir, "/results/patientMIX_EVALUATION_merge_imageJ_S.rds"))
...
for (i in 2:length(pacientes.seurat.split.orig)) {
  ...
  savename <- paste0("/results/patientMIX_merge_imageJ_S_list_im", i, ".rds")
  saveRDS(listaObjDeconv, paste0(saveDir, savename))
}

############################################################################### Statistical part
Evaluation <- readRDS(paste0(saveDir, "/results/patientMIX_EVALUATION_merge_imageJ_S.rds"))
...
# Crear un gráfico de puntos para las 4 columnas
...
ggsave(paste0(saveDir, "/results/patientMIX_merge_imageJ_S_evalMSE.png"), plot = pMSE)
ggsave(paste0(saveDir, "/results/patientMIX_merge_imageJ_S_evalMSEgray.png"), plot = pMSEgray)
ggsave(paste0(saveDir, "/results/patientMIX_merge_imageJ_S_evalSSIM.png"), plot = pSSIM)
ggsave(paste0(saveDir, "/results/patientMIX_merge_imageJ_S_evalEucl.png"), plot = pEucl)
...
ggsave(paste0(saveDir, "/results/patientMIX_merge_imageJ_S_eval1.png"), plot = peval1)
...
ggsave(paste0(saveDir, "/results/patientMIX_merge_imageJ_S_eval2.png"), plot = peval2)
...
ggsave(paste0(saveDir, "/results/patientMIX_merge_imageJ_S_eval3.png"), plot = peval3)
...
ggsave(paste0(saveDir, "/results/patientMIX_merge_imageJ_S_eval4.png"), plot = peval4)
